...
pygame.display.set_caption("Race It Down")
clock=pygame.time.Clock()
carimg=pygame.image.load('car1.png')
backgroundpic=pygame.image.load("greenstrip.jpg")
yellow_strip=pygame.image.load("yellow_strip.jpg")
strip=pygame.image.load("strip.jpg")
intro_background=pygame.image.load("NYC3.jpg")
instruction_background=pygame.image.load("NYC3.jpg")
car_width=56
pause=False
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("Race It Down",largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("Dogde the cars",smalltext)
